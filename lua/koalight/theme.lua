...
theme.set_highlights = function()
  ...
  hl(0, "@string.documentation", { fg = c.white, bg = 'NONE' })
  ...
  hl(0, "@field", { fg = c.gray, bg = 'NONE' })
  hl(0, "@property", { fg = c.paleblue, bg = 'NONE' })
  hl(0, "@variable", { fg = c.gray, bg = 'NONE', italic=true, })
